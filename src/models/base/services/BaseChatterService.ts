/**
 * BaseChatterService - Universal Odoo Communication Component
 * Base service for all chatter functionality across models
 *
 * MIGRATED: From src/services/chatterService.ts
