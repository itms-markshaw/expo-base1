/**
 * BaseOdooClient - Core Odoo XML-RPC Client
 * Base service for all Odoo model interactions
 *
 * MIGRATED: From src/services/OdooXMLRPCClient.ts
 * PRODUCTION READY: Fixed all parsing issues and authentication flow
 */
